...
const appPrimaryLightColor = Color.fromARGB(255, 157, 108, 179);
const appBgColor = Color.fromARGB(255, 43, 41, 41);
// const appBgColor = Colors.white;

const appDefaultPadding = EdgeInsets.symmetric(horizontal: 8);
